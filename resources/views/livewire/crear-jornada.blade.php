<form action="" class="md:w-1/3 space-y-5">
    <div>
        <x-input-label for="jornada" :value="__('Número de Jornada')" />
        <x-text-input id="jornada" class="block mt-1 w-full" type="number" name="jornada" :value="old('jornada')" autofocus />
    ...
    <div>
        ...
        <x-text-input id="equipo_contrario" class="block mt-1 w-full" type="text" name="equipo_contrario"
    ...
    <div>
        ...
        <x-text-input id="goles_favor" class="block mt-1 w-full" type="number" name="goles_favor" :value="old('goles_favor')" />
    ...
    <div>
        ...
        <x-text-input id="goles_contra" class="block mt-1 w-full" type="number" name="goles_contra"
